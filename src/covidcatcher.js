const totaldecasos = document.querySelector(".total_cases");
const mortes = document.querySelector(".deaths");
const recuperados = document.querySelector(".recovered");
const novoscasos = document.querySelector(".new_cases");
var settings = {
  async: true,
  crossDomain: true,
  url:
